...
<section class="p-home__kv p-home__section">
	...
	<div class="p-home__kv__movie"><a href="https://www.youtube.com/embed/-DEvn7eIeVs" class="video-open"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/home/movie.jpg" alt=""></a></div>
</section>
	...
	<div class="l-wrapper">
		<div class="p-home__tour__txt">
			...
			<div class="p-home__tour__nav">
				<ul>
					<li><a class="c-anchor__btn" href="<?php echo home_url('/tour#order'); ?>"><span>史跡紹介</span></a></li>
					<li><a class="c-anchor__btn" href="<?php echo home_url('/tour#map'); ?>"><span>地図で見る</span></a></li>
					<li><a class="c-anchor__btn" href="<?php echo home_url('/tour#walk'); ?>"><span>歩いてめぐる</span></a></li>
				</ul>
			</div>
