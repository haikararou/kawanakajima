...
<section class="c-section p-vr__trip">
	<article class="p-vr__article">
		...
		<p class="p-vr__trip__txt">※開発中画面イメージ</p>
		<div class="p-vr__trip__img">
			<img src="<?php echo get_template_directory_uri(); ?>/assets/img/vr/trip01.jpg">
			<img src="<?php echo get_template_directory_uri(); ?>/assets/img/vr/trip02.jpg">
			<img src="<?php echo get_template_directory_uri(); ?>/assets/img/vr/trip03.jpg">
			<img src="<?php echo get_template_directory_uri(); ?>/assets/img/vr/trip04.jpg">
		</div>
...
<section class="c-section p-vr__location">
	...
	<article class="p-vr__place">
		<div class="p-vr__place__img">
			<a target="_blank" rel="nofllow" href="https://maps.app.goo.gl/S9w6GdsmegjGrLnP8"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/vr/naganocity-museum.jpg"></a>
		</div>
		<div class="p-vr__place__txt">
			<h3 class="c-heading__s"><a target="_blank" rel="nofllow" href="https://maps.app.goo.gl/S9w6GdsmegjGrLnP8"><span>長野市立博物館</span></a></h3>
